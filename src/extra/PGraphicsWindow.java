...
public class PGraphicsWindow extends PGraphics {
    ...
    public void arc(float a, float b, float c, float d, float start, float stop) {
        ...
        case CORNER:
            pg.arc(a - this.getX1(), b - this.getY1(), c, d, start, stop);
            break;
        case CENTER:
            pg.arc(a - this.getX1(), b - this.getY1(), c, d, start, stop);
            break;
        case RADIUS:
            ...
            break;
        case CORNERS:
            pg.arc(a - this.getX1(), b - this.getY1(), c - this.getX1(), d - this.getY1(), start, stop);
            break;
        }
    }
    ...
    public void ellipse(float a, float b, float c, float d) {
        switch (pg.getStyle().ellipseMode) {
        case CORNER:
            pg.ellipse(a - this.getX1(), b - this.getY1(), c, d);
            break;
        case CENTER:
            pg.ellipse(a - this.getX1(), b - this.getY1(), c, d);
            break;
        case RADIUS:
            ...
            break;
        case CORNERS:
            pg.ellipse(a - this.getX1(), b - this.getY1(), c - this.getX1(), d - this.getY1());
            break;
        }
    }
    ...
    public void quad(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4) {
        pg.quad(x1 - this.getX1(), y1 - this.getY1(), x2 - this.getX1(), y2 - this.getY1(), x3 - this.getX1(),
                y3 - this.getY1(), x4 - this.getX1(), y4 - this.getY1());
    }
    ...
    public void rect(float a, float b, float c, float d) {
        ...
        case CORNER:
            pg.rect(a - this.getX1(), b - this.getY1(), c, d);
            break;
        case CENTER:
            pg.rect(a - this.getX1(), b - this.getY1(), c, d);
            break;
        case RADIUS:
            ...
            break;
        case CORNERS:
            pg.rect(a - this.getX1(), b - this.getY1(), c - this.getX1(), d - this.getY1());
            break;
        }
    }
    ...
    public void triangle(float x1, float y1, float x2, float y2, float x3, float y3) {
        pg.triangle(x1 - this.getX1(), y1 - this.getY1(), x2 - this.getX1(), y2 - this.getY1(), x3 - this.getX1(),
                y3 - this.getY1());
    }
    ...
    public void bezierVertex(float x2, float y2, float x3, float y3, float x4, float y4) {
        pg.bezierVertex(x2 - this.getX1(), y2 - this.getY1(), x3 - this.getX1(), y3 - this.getY1(), x4 - this.getX1(),
                y4 - this.getY1());
    }
    ...
    public void bezier(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4) {
        pg.bezier(x1 - this.getX1(), y1 - this.getY1(), x2 - this.getX1(), y2 - this.getY1(), x3 - this.getX1(),
                y3 - this.getY1(), x4 - this.getX1(), y4 - this.getY1());
    }
    ...
    public void curve(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4) {
        pg.curve(x1 - this.getX1(), y1 - this.getY1(), x2 - this.getX1(), y2 - this.getY1(), x3 - this.getX1(),
                y3 - this.getY1(), x4 - this.getX1(), y4 - this.getY1());
    }
